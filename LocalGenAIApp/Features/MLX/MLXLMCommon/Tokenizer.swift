...
public func loadTokenizer(configuration: MLXModelConfiguration, hub: HubApi) async throws -> Tokenizer
{
...
public func loadTokenizerConfig(configuration: MLXModelConfiguration, hub: HubApi) async throws -> (
    Config, Config
) {
